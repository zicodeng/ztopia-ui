/**
 * Attribution
 * This code adapted from the following codepen: https://codepen.io/nathangath/pen/RgvzVY/
 */

import * as React from 'react';
import { cx } from 'react-emotion';

const IconPartyParrot: React.SFC<{
    className?: string;
}> = props => {
    const { className, ...restProps } = props;
    const classNames = cx('ztopia-icon-party-parrot', className);
    return (
        <svg
...
export default IconPartyParrot;
